                ...
                <Card className="w-full max-w-sm border-gray-200 shadow-lg">
                    <CardContent className="px-8 py-10 text-center">
                        <img
                            ...
                            height={56}
                        />
                        <h1 className="mb-6 text-base font-semibold tracking-tight text-gray-900">
                        ...
                        <h2 className="text-6xl font-bold tracking-tight text-gray-200">404</h2>
                        ...
                        <div className="mt-8">
                            <Button
                                size="lg"
                                className="h-12 gap-2 bg-gray-900 text-sm font-semibold tracking-wide text-white hover:bg-gray-800"
                                asChild
                            >
                                <Link href="/">
